...
@Schema(description = "주변 고스트 런 코스 조회 요청")
public record NearbyGhostCoursesRequest(
        ...
        @Schema(
                description = "주변 고스트 런 코스 정렬 기준입니다. DISTANCE는 가까운 순, GHOST_RUN_COUNT는 완료된 고스트 런 세션 수가 많은 순으로 정렬합니다.",
                example = "DISTANCE",
                nullable = true
        )
    ...
    public NearbyGhostCoursesRequest {
        sortBy = sortBy == null ? NearbyGhostCourseSortBy.DISTANCE : sortBy;
